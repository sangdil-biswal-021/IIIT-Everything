              ...
              >
                <div className="md:w-[50vw] w-[90vw]  flex flex-col md:p-5 md:m-5 md:mt-20 text-mono text-white text-center md:text-left overflow-x-hidden">
                  ...
                  <text className="text-[14px] mt-2 leading-7">
                    Welcome to IIIT Everything, your ultimate resource hub for
                    all things related to studying at our esteemed institution.
                    Our dedicated team of creators has painstakingly compiled a
                    comprehensive collection of study materials, including
                    question papers, recommended books, and insightful notes,
                    all crafted with the aim of aiding both juniors and peers in
                    their academic pursuits. We understand the value of easy
                    access to such documents in enhancing the learning
                    experience, and thus, we are committed to providing a
                    platform that fosters collaborative learning and knowledge
                    sharing. Explore our repository to empower your educational
                    journey and make the most out of your time here at IIIT
                    Bhubaneswar.
                  </text>
                </div>
              </motion.div>
