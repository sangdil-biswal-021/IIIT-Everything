...
export default function Developers(props) {
  return (
    <div
      className="h-[515px]    bg-no-repeat bg-cover flex flex-col items-center justify-around py-10 px-2 rounded-[40px]"
      style={{ backgroundImage: `url(${img})` }}
    >
      <div className="h-[250px] w-[250px] rounded-full bg-[#211E2E] flex items-center justify-center">
        <div
          className="h-[225px] w-[225px] rounded-full bg-no-repeat bg-cover"
